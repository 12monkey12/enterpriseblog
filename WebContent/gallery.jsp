...
<body>
				...
				<span class="navbar-toggler-icon"></span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
					  ...
					  菜单 <i class="fa fa-angle-down" aria-hidden="true"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="contact.jsp">建议我们</a>
                            </li>
                        </ul>
                        <!-- ls -->
    ...
    <div class="cpy-right text-center py-3">
        <p class="copy-w3layouts">Copyright &copy; 2018.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a>
        </p>
    </div>
     //copy-w3layoutsright -->
    <!--model-forms-->
