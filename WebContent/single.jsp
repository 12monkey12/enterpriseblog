        ...
        <div class="container py-md-5 py-5">
            <div class="ab-info-grids pt-md-5 pt-0">
                <div class="blog-sec pt-md-3 pt-0">
                    <h3 class="tittle text-uppercase text-center mb-lg-5 mb-3 inner-tittle"><span class="sub-tittle">Recent </span> 个人页面</h3>
                    <div class="row mt-lg-5 mt-3">

                        <div class=" blog-left-content">
                            <div class="card" data-aos="fade-up">
                                <div align="center"><img class="card-img-top" src="/blog/${readmore.pics }" alt="Card image cap"></div>
                                <div class="card-body">
                                    <h6 class="date"><span>
                                     By: ${readmore.department }</span> ${readmore.addtime }</h6>
                                    <h5 class="card-title"><a class="b-post text-dark" href="javascript:void(0);">${readmore.title }</a></h5>
                                    <p class="card-text">${readmore.content }</p>
                            ...
                            <div class="comment-top">
                                ...
                                <div class="media">
                                    <img src="/user/${comment.photo }" alt="" class="img-fluid" style = "width:80px;height:80px;"/>
                                    <div class="media-body">
                                    	<div style = "border-bottom:1px solid">
                                        	<h5 class="mt-0" style = "display:inline">${comment.uname }</h5>
                            ...
                            <div class="comment-top contact">
                                ...
                                <form name="contactform " id="contactform" method="post" action="#" onsubmit="return(validate());" novalidate="novalidate">
                                    <div class="form-group" data-aos="fade-up">
                                        <label>我能帮你什么嘛?</label>
                                        <textarea name="issues" class="form-control" id="iq" placeholder="Enter Your Message Here"
                                        style = "height:180px"></textarea>
                                    </div>
                                    <button type="button" class="btn btn-primary" onclick = "toComment()">提交</button>
                                </form>
